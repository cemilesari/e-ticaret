...
class ProductRouteView(APIViewBase):
    """
Reseller Product Route View
"""
    def get(self, request, *args, **kwargs):
        response = {
            "Reseller Product List Route " : reverse(viewname="api:product_list_view" , request=request),
            "Reseller Product Create View" : reverse(viewname="api:product_create_view",request=request),
