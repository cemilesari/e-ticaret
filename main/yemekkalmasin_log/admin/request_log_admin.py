...
from main.yemekkalmasin_log.plugins import plugins
from main.yemekkalmasin_log.traffic import modules
...
class RequestLogAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        return super(RequestLogAdmin, self).get_queryset(request).select_related('user')
    ...
    def get_urls(self):
        ...
        ] + super(RequestLogAdmin, self).get_urls()

    def overview(self, request):
        qs = RequestLog.objects.this_month()
    ...
    def traffic(self, request):
        ...
        days_qs = [(day, RequestLog.objects.day(date=day)) for day in days]
